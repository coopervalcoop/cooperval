...
import { IMAGES, STORES, SERVICES, COUNCILS, STATS } from "@/lib/constants";
                      ...
                      <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-10">
                        ...
                        <div className="shrink-0">
                          <a
                            ...
                            className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#25d366] hover:bg-[#20bd5a] text-white font-semibold rounded-full transition-all duration-300 shadow-md hover:shadow-lg"
                          >
